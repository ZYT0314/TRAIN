...
OUTPUT_FIGURE = "Development_Clinical_Pairwise_ROC.png"
N_REPEATS = 10
TEST_SIZE = 0.30
BASE_SEED = 42
...
def run_single_task(task_config, sheet_name):
    ...
    for i in range(N_REPEATS):
        ...
        print(f"{task_name}迭代 {i + 1} 性能: 准确率={accuracy:.3f}, AUROC={auc_value:.3f}")
