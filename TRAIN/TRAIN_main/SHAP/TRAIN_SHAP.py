...
def main():
    ...
    print("="*50)
    pretrain_file_paths = [
        'Pre-LCRA_VS_Control28.xlsx',
        'Pre-RABC_RAControl96.xlsx',
        'Pre-DBRA_VS_Control.xlsx'
    ]
    pretrain_results = []
    ...
    print("=== 步骤2：加载数据 ===")
    print("="*50)
    data = pd.read_excel("321融合.xlsx", header=0)
    ...
    group_index_df.to_excel('best_model_321融合-Pre.xlsx', index=False)
    print("\n最佳模型分组信息如下：")
    ...
    shap_df['group'] = all_y
    shap_df.to_excel('feature_shap_321融合-Pre.xlsx', index=False)
    ...
    shap_rank_df.to_excel('SHAP_Rank_321融合-Pre.xlsx', index=False)
